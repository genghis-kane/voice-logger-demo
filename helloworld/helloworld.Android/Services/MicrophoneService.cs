...
namespace helloworld.Droid
{
    class MicrophoneService : IMicrophoneService
    {
        ...
        private readonly string[] _permissions = { Manifest.Permission.RecordAudio };
        ...
        private void RequestMicPermission()
        {
            ...
            if (ActivityCompat.ShouldShowRequestPermissionRationale(currentActivity, Manifest.Permission.RecordAudio))
            {
                ...
                {
                    ((Activity)currentActivity).RequestPermissions(_permissions, REQUEST_MIC);

                }).Show();
            }
            else
            {
                ActivityCompat.RequestPermissions(((Activity)currentActivity), _permissions, REQUEST_MIC);
            }
        }
