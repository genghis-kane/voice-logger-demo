...
namespace helloworld
{
    ...
    {
        private string kwsModelFile = "Computer.table";

        private KeywordRecognitionModel _model = null;
        private KeywordRecognitionResult _result = null;
        private KeywordRecognizer _recognizer = null;
...
//            await DoSpeechRecognition().ConfigureAwait(false);
        ...
        private async Task DoSpeechRecognition()
        {
            try
            {
